...
final class DialogConfig {
    ...
    static final String WARNING_ICON = "/assets/tainote_warning.png";
    static final int ICON_SIZE_LARGE = 96;
    static final int ICON_SIZE_SMALL = 48;

    static final String UNSAVED_HEADER = "Unsaved changes";
    static final String UNSAVED_CONTENT = "You have unsaved changes. Do you want to continue?";
    static final String UNSAVED_CONTINUE_BTN = "Continue";

    static final String IMPORT_OVERWRITE_HEADER = "Tainote already exists";
